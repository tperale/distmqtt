...
class BrokerProtocolHandler(ProtocolHandler):
    ...
    async def mqtt_acknowledge_subscription(
        self, packet_id, return_codes, group_keys, topics
    ):
        suback = SubackPacket.build(packet_id, return_codes, group_keys, topics)
